...
log_file = os.path.join(BASE_DIR, "logs", "trading_bot.log")
...
def createLogOrder(order):
    ...
    # Se ainda não executou nada, mostra o total enviado
    quantity = orig_qty if executed_qty == 0 else executed_qty
    asset = order['symbol']
